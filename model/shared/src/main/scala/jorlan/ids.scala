...
/** Primary key for [[ChannelIdentity]] records. */
...
/** Identifies the embedding model that produced a [[MemoryEmbedding]] vector (e.g. `"nomic-embed-text"`).
  */
