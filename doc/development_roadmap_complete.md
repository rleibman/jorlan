...
module
14.6 [x] **Google Contacts skill**: search, read contacts new sbt module
...
14.11 [x] **HTTP fetch skill**: let agents make HTTP GET/POST requests to external URLs. Capability-gated with an
